                    ...
                    <div className="row g-4 justify-content-center">
                        {
                            api && api.map((data, index) => {
                                return (
                                    <div className="packages-item col-lg-4 col-md-6" key={data.id}>
                                        <div className="packages-img">
                                            <img src={data.image} className="img-fluid w-100 rounded-top" alt="Image" />
                                            <div className="packages-info d-flex border border-start-0 border-end-0 position-absolute" style={{ width: '100%', bottom: 0, left: 0, zIndex: 5 }}>
                                                <small className="flex-fill text-center border-end py-2"><i className="fa fa-map-marker-alt me-2" />{data.location}</small>
                                                <small className="flex-fill text-center border-end py-2"><i className="fa fa-calendar-alt me-2" />{data.day} days</small>
                                                <small className="flex-fill text-center py-2"><i className="fa fa-user me-2" />{data.person} Person</small>
                                            </div>
                                            <div className="packages-price py-2 px-3">{data.price}</div>
                                        </div>
                                        <div className="packages-content bg-light">
                                            <div className="p-4 pb-0">
                                                <h5 className="mb-0">{data.location}</h5>
                                                <small className="text-uppercase">{data.hotel}</small>
                                                <div className="mb-3">
                                                    <span style={{fontSize: "16px", color: "#13357b"}}>{data.rating}</span>
